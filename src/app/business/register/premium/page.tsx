...
import { registerPremiumBusinessAction } from "./actions";
import { BUSINESS_PLANS } from "@/data/business-plans";
import styles from "../register.module.css";

export const metadata: Metadata = { title: "הרשמה למסלול Premium | נווה שמיר", robots: { index: false, follow: false } };
      ...
      <main id="main-content">
        <div className={styles.container}>
          ...
          <p className={styles.description}>
            החשיפה המקסימלית באתר — הופעה מודגשת ותגית עסק מאומת. הפרטים יישלחו לבדיקה של צוות הפורטל — לאחר אישור,
            העסק שלכם יופיע בארכיון העסקים.
          </p>
          <RegisterBusinessForm
            action={registerPremiumBusinessAction}
            planIntro={
