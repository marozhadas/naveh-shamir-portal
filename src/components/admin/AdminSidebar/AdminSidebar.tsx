...
import { LayoutDashboard, Building2, Bell, Settings, BarChart3, Recycle, CalendarDays, Phone, MessageSquare, MessagesSquare, Newspaper, Star, X } from "lucide-react";
...
export function AdminSidebar({ pendingBusinessesCount, openNotificationsCount, mobileOpen, onCloseMobile }: AdminSidebarProps) {
  ...
  const navItems: NavItem[] = [
    ...
    { href: "/admin/reviews", label: "ביקורות", icon: <Star size={18} aria-hidden="true" /> },
